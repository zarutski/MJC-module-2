...
public class UserController {
    ...
    public UserController(UserService userService, OrderService orderService, HateoasProvider hateoas,
                          PaginationProvider<UserDTO> pagination, PaginationProvider<OrderDTO> orderPagination) {
    ...
    public OrderDTO readOrder(@PathVariable Long orderId) {
        return hateoas.addLinksToOrder(orderService.readById(orderId));
    }
